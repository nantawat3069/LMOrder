...
import { getStatusBadge, getPaymentBadge } from './utils/badges';
        ...
        <div className="container mt-4 pb-5">
                ...
                <div className="d-flex flex-wrap justify-content-between align-items-center">
                    ...
                    <div className="d-flex gap-2">
                        ...
                        <button
                            ...
                            onClick={() => { handleTabChange('notifications'); markNotificationsRead(user?.id); }}
                        >
                                ...
                                <div key={o.id} className="col-md-6 col-lg-4 mb-3">
                                    <div className="card p-3 shadow border-0 h-100">
                                        ...
                                        <div className="d-flex gap-2 mb-2">
                                            ...
                                            >
                                                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3"><path d="M798-120q-125 0-247-54.5T329-329Q229-429 174.5-551T120-798q0-18 12-30t30-12h162q14 0 25 9.5t13 22.5l26 140q2 16-1 27t-11 19l-97 98q20 37 47.5 71.5T387-386q31 31 65 57.5t72 48.5l94-94q9-9 23.5-13.5T670-390l138 28q14 4 23 14.5t9 23.5v162q0 18-12 30t-30 12ZM241-600l66-66-17-94h-89q5 41 14 81t26 79Zm358 358q39 17 79.5 27t81.5 13v-88l-94-19-67 67ZM241-600Zm358 358Z"/></svg> โทร
                                            </button>
                                            <button
                                                className="btn btn-sm btn-soft-primary py-1 px-3 flex-grow-1 d-flex align-items-center justify-content-center gap-2"
                                                style={{
                                                    fontSize: '0.9rem',
                                                    fontWeight: '500',
                                            ...
                                            >
                                                {copiedOrderId === o.id ? (
                                                    <>
                                                        <span style={{fontSize: '1.1rem'}}>✓</span> คัดลอกแล้ว
                                                    </>
                                                ) : (
                                                    <>
                                                        <svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="#0d6efd"><path d="M200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h167q11-35 43-57.5t70-22.5q40 0 71.5 22.5T594-840h166q33 0 56.5 23.5T840-760v560q0 33-23.5 56.5T760-120H200Zm0-80h560v-560h-80v120H280v-120h-80v560Zm308.5-571.5Q520-783 520-800t-11.5-28.5Q497-840 480-840t-28.5 11.5Q440-817 440-800t11.5 28.5Q463-760 480-760t28.5-11.5Z"/></svg>
                                                        {o.customer_phone}
                                                    </>
                                                )}
                                            </button>
            ...
            {activeTab === 'settings' && (
                <div className="card shadow-sm p-4 mx-auto" style={{maxWidth: '800px'}}>
                    ...
                    <div className="d-grid gap-2">
                        <button className="btn btn-outline-danger py-2 d-inline-flex align-items-center justify-content-center gap-1" onClick={() => confirmAction('ออกจากระบบ', 'ยืนยันการออกจากระบบ?', () => { localStorage.removeItem('user'); navigate('/'); })}>
                            <span className="material-icons" style={{fontSize: '20px'}}>logout</span> ออกจากระบบ
                        </button>
                    </div>

                    <hr className="my-5"/>

                    <div className="bg-soft-danger p-3 rounded border border-danger mb-3">
            ...
            <BanOverlay
                ...
                subtitle="บัญชีร้านค้าของคุณถูกแอดมินระงับการใช้งาน"
            />
            ...
            <div className="d-block d-md-none fixed-bottom bg-white border-top shadow-lg" style={{zIndex: 1050}}>
                <div className="d-flex justify-content-around py-2">
                    ...
                    <button className={`btn border-0 position-relative ${activeTab === 'notifications' ? 'text-primary' : 'text-muted'}`} onClick={() => { handleTabChange('notifications'); markNotificationsRead(user?.id); }}>
                        <div style={{fontSize: '1.5rem'}}>🔔</div>
